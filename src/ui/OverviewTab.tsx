...
export const OverviewTab: React.FC<Props> = ({ rows }) => {
  ...
  const cards: { label: string; value: string; color?: string }[] = [
    ...
    { label: "总回购 MX", value: fmt(last.total_ar_buyback), color: "#06b6d4" },
    ...
    { label: "净卖压 MX", value: fmt(last.total_ar_sold - last.total_ar_buyback), color: last.total_ar_sold > last.total_ar_buyback ? "#ef4444" : "#22c55e" },
    ...
    { label: "总 MX 发行", value: fmt(last.total_ar_emitted) },
    { label: "总 MX 销毁(池)", value: fmt(last.total_ar_burned) },
